...
public class CameraView : MonoBehaviour
{
    ...
    [SerializeField] public float upDownSpeed = 2.0f;
    ...
    void Update()
    {
        ...
        float upDown = Input.GetAxis("Mouse Y") * upDownSpeed * Time.deltaTime;
        ...
        transform.rotation = Quaternion.Euler(newRotationX, currentRotation.y + mouseX, 0);
